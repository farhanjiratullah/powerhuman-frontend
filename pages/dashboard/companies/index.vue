    ...
    <div>
        ...
        >
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="text-[32px] font-semibold text-dark">Companies</div>
            </div>
            ...
            <div class="mb-[30px]">
                ...
                >
                    <div>
                        ...
                        <p class="text-grey">Make your company</p>
                    </div>
                    <NuxtLink
                        :to="{ name: 'dashboard-companies-create' }"
                        class="btn btn-primary"
                        >Build New Company</NuxtLink
                    >
                </div>
            </div>
